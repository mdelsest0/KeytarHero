...
HD_PWD='O:/CS56_S23/vga_midi/vga_midi/vga_midi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test_pattern_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_test_pattern_shell.tcl
