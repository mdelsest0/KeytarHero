...
HD_PWD='O:/CS56_S23/vga_midi/vga_midi/vga_midi.runs/blk_pix_booleans_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_pix_booleans.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_pix_booleans.tcl
