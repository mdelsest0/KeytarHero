...
HD_PWD='O:/CS56_S23/vga_midi/vga_midi/vga_midi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test_pattern_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_test_pattern_shell.tcl -notrace
